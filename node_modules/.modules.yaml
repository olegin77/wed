...
hoistedDependencies:
  ...
  '@eslint-community/eslint-utils@4.9.0(eslint@9.12.0)':
  ...
  apps/svc-admin:
    svc-admin: private
  apps/svc-analytics:
    svc-analytics: private
  apps/svc-auth:
    svc-auth: private
  apps/svc-catalog:
    svc-catalog: private
  apps/svc-enquiries:
    svc-enquiries: private
  apps/svc-guests:
    svc-guests: private
  apps/svc-payments:
    svc-payments: private
  apps/svc-vendors:
    svc-vendors: private
  apps/svc-website:
    '@wt/website': private
...
pendingBuilds:
  - '@prisma/client@6.17.1(prisma@5.19.0)(typescript@5.9.3)'
  - prisma@5.19.0
  - '@prisma/engines@5.19.0'
  - esbuild@0.25.11
  - '@prisma/client@5.19.0(prisma@5.19.0)'
prunedAt: Wed, 22 Oct 2025 16:21:59 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
